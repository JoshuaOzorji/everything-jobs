...
// async function fetchJobsPaginated(page = 1, perPage = JOBS_PER_PAGE) {
...
// 	const { jobs, totalCount } = await fetchJobsPaginated(currentPage);
...
// LatestJobs.tsx - modified to accept page parameter
import { JobCardProps } from "@/types";
import JobCard from "./JobCard";
import { client } from "@/sanity/lib/client";
import { groq } from "next-sanity";
